...
class hipermercadoelportenoSpider(CrawlSpider):
    name = "hipermercadoelporteno"
    allowed_domains = ['www.hipermercadoelporteno.com']
    start_urls = [
        "http://www.hipermercadoelporteno.com/?content=estoque"
    ]
    rules = (
    ...
    def parseItem(self, response):
        ...
        item['image_urls'] = ['http://www.hipermercadoelporteno.com/' + 
