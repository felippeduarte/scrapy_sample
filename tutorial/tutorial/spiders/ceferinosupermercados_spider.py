...
class ceferinosupermercadosSpider(CrawlSpider):
    name = "ceferinosupermercados"
    allowed_domains = ['www.ceferinosupermercados.com']
    start_urls = [
        "http://www.ceferinosupermercados.com/?content=estoque"
    ]
    rules = (
    ...
    def parseItem(self, response):
        ...
        item['image_urls'] = ['http://www.ceferinosupermercados.com/' + 
