...
class supermercadoASpider(CrawlSpider):
    name = "supermercadoA"
    allowed_domains = ['www.supermercadoA.com']
    start_urls = [
        "http://www.supermercadoA.com/?content=estoque"
    ]
    rules = (
    ...
    def parseItem(self, response):
        ...
        item['image_urls'] = ['http://www.supermercadoA.com/' + 
