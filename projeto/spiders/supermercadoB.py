...
class supermercadoBSpider(CrawlSpider):
    name = "supermercadoB"
    allowed_domains = ['www.supermercadoB.com']
    start_urls = [
        "http://www.supermercadoB.com/?content=estoque"
    ]
    rules = (
    ...
    def parseItem(self, response):
        ...
        item['image_urls'] = ['http://www.supermercadoB.com/' + 
